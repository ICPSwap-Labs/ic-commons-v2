...
function text_ic0()
{
    ...
    dfx canister call TestIC0 update_settings_add_controller "(principal \"$testId\", principal \"sximj-syc6w-jgdou-fdu37-dutet-n2ncf-hc7so-o2lmj-hkxqb-mj2lh-eqe\")"
    dfx canister call TestIC0 canister_status "(principal \"$testId\")"

    echo "==> remove controller by canister"
    dfx canister call TestIC0 update_settings_remove_controller "(principal \"$testId\", principal \"sximj-syc6w-jgdou-fdu37-dutet-n2ncf-hc7so-o2lmj-hkxqb-mj2lh-eqe\")"
    dfx canister call TestIC0 canister_status "(principal \"$testId\")"
}
